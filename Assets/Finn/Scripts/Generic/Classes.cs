...

{
    ...
    {
        if (point.x < position.x + size.x && point.x > position.x && point.y < position.y + size.y && point.y > position.y)
        {
            return true;
        }
        else
...
public static class DetectObstaclesInPosition
{
    ...
    ///// <summary>
    ///// returns a list of completeobstaclemapreturns. For use when quickly expanding the obstacle map
    ///// </summary>
    ///// <param name="obstacles"></param>
    ///// <param name="nodeSize"></param>
    ///// <param name="mapTargets"></param>
    ///// <param name="others"></param>
    ///// <returns></returns>
    //public static List<CompleteObstacleMapReturn> PartialObstacleMapBatch(List<Obstacle> obstacles, Float2Bounds mapBounds, List<int2> newSectorsToCalculate, int flowFieldSize)
    //{
    //    for(int i = 0; i < newSectorsToCalculate.Count; i++)
    //    {
    //        for(int x = 0; x < flowFieldSize; x++)
    //        {
    //            for(int y = 0; y < flowFieldSize; y++)
    //            {
